...
import {
  UpsertSocialReportInput,
  GetSocialReportInput,
  UpsertWellbeingProfileInput,
  ListOverdueReviewsInput,
...
// Re-export types for server-side consumers that use type-only imports
export type {
  UpsertSocialReportInput as UpsertSocialReportInputType,
  UpsertWellbeingProfileInput as UpsertWellbeingProfileInputType,
  ListOverdueReviewsInput as ListOverdueReviewsInputType,
} from '@/lib/schemas/social';
