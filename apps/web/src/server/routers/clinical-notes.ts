...
// '@/lib/schemas/clinical-notes'.
// ---------------------------------------------------------------------------

import {
  NursingNoteShiftSchema,
  NursingNoteCategorySchema,
  MedicalNoteTypeSchema,
  CreateNursingNoteInput,
  ListNursingNotesByResidentInput,
  ListForShiftHandoverInput,
  CreateMedicalNoteInput,
  ListMedicalNotesByResidentInput,
...
export type {
  CreateNursingNoteInput as CreateNursingNoteInputType,
  ListNursingNotesByResidentInput as ListNursingNotesByResidentInputType,
  ListForShiftHandoverInput as ListForShiftHandoverInputType,
  CreateMedicalNoteInput as CreateMedicalNoteInputType,
  ListMedicalNotesByResidentInput as ListMedicalNotesByResidentInputType,
} from '@/lib/schemas/clinical-notes';
