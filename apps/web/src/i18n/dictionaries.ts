...
const es: Record<string, string> = {
  ...
  // ---------------------------------------------------------------------------
  // i18n Remediation 2026-06-14 — Pantallas sin traducir (H-01..H-09)
  // ---------------------------------------------------------------------------

  // Centros/[id] — gestión de unidades y plazas (H-01)
  'centers.detail.loading':           'Cargando…',
  'centers.detail.notFound':          'Centro no encontrado.',
  'centers.detail.backToCenters':     '← Centros',
  'centers.detail.occupancy':         'Ocupación: {occupied} / {total} plazas · {residents} residentes',
  'centers.detail.addUnit':           'Añadir unidad',
  'centers.detail.unit.name':         'Nombre',
  'centers.detail.unit.floor':        'Planta (opcional)',
  'centers.detail.unit.submit':       'Añadir unidad',
  'centers.detail.addBed':            'Añadir plaza',
  'centers.detail.bed.unit':          'Unidad',
  'centers.detail.bed.unitPh':        'Selecciona…',
  'centers.detail.bed.code':          'Código',
  'centers.detail.bed.submit':        'Añadir plaza',
  'centers.detail.noUnits':           'No hay unidades todavía.',
  'centers.detail.noBeds':            'Sin plazas.',
  'centers.detail.deleteUnit':        'Eliminar unidad',
  'centers.detail.deleteBed.aria':    'Eliminar plaza {code}',
  'centers.detail.bed.free':          'Libre',
  'centers.detail.unit.created':      'Unidad creada.',
  'centers.detail.bed.created':       'Plaza creada.',
  'centers.detail.bed.deleted':       'Plaza eliminada.',
  'centers.detail.unit.deleted':      'Unidad eliminada.',
  'centers.detail.deleteUnit.title':  'Eliminar la unidad "{name}"',
  'centers.detail.deleteUnit.desc':   'Esta acción no se puede deshacer.',
  'centers.detail.deleteUnit.confirm': 'Eliminar',
  'centers.detail.deleteBed.title':   'Eliminar la plaza "{code}"',
  'centers.detail.deleteBed.desc':    'Esta acción no se puede deshacer.',
  'centers.detail.deleteBed.confirm': 'Eliminar',

  // Equipo/familias — acceso familiar (H-02)
  'family.access.title':              'Acceso de familias',
  'family.access.subtitle':           'Vincula familiares a un residente y controla qué pueden ver en el portal.',
  'family.access.grant.title':        'Dar acceso a un familiar',
  'family.access.resident':           'Residente',
  'family.access.resident.ph':        'Elige…',
  'family.access.relationship':       'Parentesco',
  'family.access.email':              'Email del familiar',
  'family.access.name':               'Nombre (opcional)',
  'family.access.password':           'Contraseña provisional',
  'family.access.password.ph':        'mín. 8 caracteres',
  'family.access.submit':             'Conceder acceso',
  'family.access.submitting':         'Concediendo…',
  'family.access.granted':            'Acceso concedido. Comunica las credenciales al familiar.',
  'family.access.links.title':        'Vínculos actuales',
  'family.access.links.loading':      'Cargando…',
  'family.access.links.empty':        'Todavía no hay familiares con acceso.',
  'family.access.revoke':             'Revocar',
  'family.access.revoked':            'Acceso revocado.',
  'family.access.revoke.title':       'Revocar acceso',
  'family.access.revoke.desc':        'Se retirará el acceso de {email} al portal. Esta acción queda registrada.',
  'family.access.revoke.confirm':     'Revocar',
  'family.access.noResident.error':   'Elige un residente.',
  'family.access.privacy.legend':     'Privacidad del portal',
  'family.access.privacy.care':       'Novedades',
  'family.access.privacy.medication': 'Medicación',
  'family.access.privacy.assessments': 'Valoraciones',
  'family.access.resident.label':     'Residente:',
  'family.access.backToTeam':         '← Equipo',
  'family.access.privacy.updated':    'Privacidad actualizada.',

  // Atención directa — flujo auxiliar (H-09 / UX-A01)
  'care.page.title':                  'Atención directa',
  'care.offline.notice':              'Sin conexión: tus registros se guardan en el dispositivo y se envían solos al recuperar la red.',
  'care.vitals.title':                'Constantes',
  'care.vitals.submit':               'Registrar constantes',
  'care.intake.title':                'Ingesta',
  'care.intake.meal':                 'Comida',
  'care.intake.quantity':             'Cantidad',
  'care.intake.submit':               'Registrar ingesta',
  'care.stool.title':                 'Deposición',
  'care.stool.notes':                 'Notas',
  'care.stool.submit':                'Registrar deposición',
  'care.incident.title':              'Incidencia',
  'care.incident.label':              'Descripción',
  'care.incident.submit':             'Registrar incidencia',
  'care.records.title':               'Registros recientes',
  'care.pending.title':               'Pendientes de sincronizar ({count})',
  'care.pending.syncNow':             'Sincronizar ahora',
  'care.pending.retrying':            'Reintentando',
  'care.pending.pending':             'Pendiente',
  'care.yes':                         'Sí',
  'care.no':                          'No',

  // Facturación — strings residuales (H-03 / UX-A02)
  'billing.tariffs.vatYes':           'Sí',
  'billing.tariffs.vatNo':            'No',
  'billing.tariffs.edit':             'Editar',
  'billing.filter.yearAll':           'Año: Todos',
  'billing.filter.monthAll':          'Mes: Todos',
  'billing.invoices.resident':        'Residente',
  'billing.invoices.year':            'Año',
  'billing.invoices.month':           'Mes',
  'billing.invoices.series':          'Serie',
  'billing.invoices.payer':           'Pagador:',
  'billing.invoices.concept':         'Concepto',
  'billing.invoices.base':            'Base',
  'billing.invoices.vat':             'IVA',
  'billing.invoices.lineTotal':       'Total',
  'billing.invoices.exempt':          '(exento)',
  'billing.invoices.grandTotal':      'TOTAL',
  'billing.invoices.creating':        'Creando…',
  'billing.invoices.draft.title':     'Factura',
  'billing.access.restricted':        'Acceso restringido',
  'billing.access.noPermission':      'Tu rol no tiene permiso para ver la sección de facturación.',

  // Residentes/[id] — datos personales y tabs (H-04 / UX-A03)
  'exp.datos.title':                  'Datos personales',
  'exp.datos.tab':                    'Datos',
  'exp.escalas.tab':                  'Escalas',
  'exp.contactos.tab':                'Contactos',
  'exp.alergias.tab':                 'Alergias',
  'exp.datos.birthDate':              'Nacimiento',
  'exp.datos.admissionDate':          'Ingreso',
  'exp.datos.nationalId':             'DNI/NIE',
  'exp.datos.center':                 'Centro',
  'exp.datos.bed':                    'Plaza',
  'exp.datos.bloodGroup':             'Grupo sanguíneo',
  'exp.datos.language':               'Idioma preferente',
  'exp.datos.noBed':                  'Sin plaza',
  'exp.status.active':                'Activo',
  'exp.status.discharged':            'Finalizada',
  'exp.consent.ok':                   'Consentimiento ok',
  'exp.consent.missing':              'Sin consentimiento',
  'exp.falls.witnessed':              'Presenciada',
  'exp.falls.injuries':               'Lesiones: {text}',
  'exp.dx.diag':                      'Diag.:',

  // Admisiones — strings residuales (H-05 / UX-A04)
  'admissions.tab.pipeline':          'Lista de espera / Pipeline',
  'admissions.forecast.date':         'Fecha',
  'admissions.form.center.ph':        'Selecciona un centro…',
  'admissions.form.unit.none':        'Sin preferencia de unidad',
  'admissions.actions.selectStatus':  'Selecciona el nuevo estado…',

  // MFA card — strings residuales (H-07 / UX-A04)
  'mfa.description':                  'La verificación en dos pasos añade una capa extra de seguridad a tu cuenta. Necesitarás una aplicación de autenticación (Google Authenticator, Authy, etc.) para obtener un código de acceso de 6 dígitos cada vez que inicies sesión.',
  'mfa.activate':                     'Activar',
  'mfa.codesLow':                     'Tienes pocos códigos de recuperación disponibles. Considera regenerarlos.',

  // Acceso restringido global (facturación/admisiones)
  'access.restricted.title':          'Acceso restringido',
  'access.restricted.desc':           'Tu rol no tiene permiso para ver esta sección.',
};
...
const ca: Record<string, string> = {
  ...
  // ---------------------------------------------------------------------------
  // i18n Remediation 2026-06-14 — Pantalles sense traduir (H-01..H-09) — ca-ES
  // ---------------------------------------------------------------------------

  // Centres/[id] — gestió d'unitats i places (H-01)
  'centers.detail.loading':           'Carregant…',
  'centers.detail.notFound':          'Centre no trobat.',
  'centers.detail.backToCenters':     '← Centres',
  'centers.detail.occupancy':         'Ocupació: {occupied} / {total} places · {residents} residents',
  'centers.detail.addUnit':           'Afegir unitat',
  'centers.detail.unit.name':         'Nom',
  'centers.detail.unit.floor':        'Planta (opcional)',
  'centers.detail.unit.submit':       'Afegir unitat',
  'centers.detail.addBed':            'Afegir plaça',
  'centers.detail.bed.unit':          'Unitat',
  'centers.detail.bed.unitPh':        'Selecciona…',
  'centers.detail.bed.code':          'Codi',
  'centers.detail.bed.submit':        'Afegir plaça',
  'centers.detail.noUnits':           'Encara no hi ha unitats.',
  'centers.detail.noBeds':            'Sense places.',
  'centers.detail.deleteUnit':        'Eliminar unitat',
  'centers.detail.deleteBed.aria':    'Eliminar plaça {code}',
  'centers.detail.bed.free':          'Lliure',
  'centers.detail.unit.created':      'Unitat creada.',
  'centers.detail.bed.created':       'Plaça creada.',
  'centers.detail.bed.deleted':       'Plaça eliminada.',
  'centers.detail.unit.deleted':      'Unitat eliminada.',
  'centers.detail.deleteUnit.title':  'Eliminar la unitat "{name}"',
  'centers.detail.deleteUnit.desc':   'Aquesta acció no es pot desfer.',
  'centers.detail.deleteUnit.confirm': 'Eliminar',
  'centers.detail.deleteBed.title':   'Eliminar la plaça "{code}"',
  'centers.detail.deleteBed.desc':    'Aquesta acció no es pot desfer.',
  'centers.detail.deleteBed.confirm': 'Eliminar',

  // Equip/famílies — accés familiar (H-02)
  'family.access.title':              'Accés de famílies',
  'family.access.subtitle':           'Vincula familiars a un resident i controla què poden veure al portal.',
  'family.access.grant.title':        'Donar accés a un familiar',
  'family.access.resident':           'Resident',
  'family.access.resident.ph':        'Tria…',
  'family.access.relationship':       'Parentiu',
  'family.access.email':              'Correu del familiar',
  'family.access.name':               'Nom (opcional)',
  'family.access.password':           'Contrasenya provisional',
  'family.access.password.ph':        'mín. 8 caràcters',
  'family.access.submit':             'Concedir accés',
  'family.access.submitting':         'Concedint…',
  'family.access.granted':            "Accés concedit. Comunica les credencials al familiar.",
  'family.access.links.title':        'Vincles actuals',
  'family.access.links.loading':      'Carregant…',
  'family.access.links.empty':        'Encara no hi ha familiars amb accés.',
  'family.access.revoke':             'Revocar',
  'family.access.revoked':            'Accés revocat.',
  'family.access.revoke.title':       'Revocar accés',
  'family.access.revoke.desc':        "Es retirarà l'accés de {email} al portal. Aquesta acció queda registrada.",
  'family.access.revoke.confirm':     'Revocar',
  'family.access.noResident.error':   'Tria un resident.',
  'family.access.privacy.legend':     'Privacitat del portal',
  'family.access.privacy.care':       'Novetats',
  'family.access.privacy.medication': 'Medicació',
  'family.access.privacy.assessments': 'Valoracions',
  'family.access.resident.label':     'Resident:',
  'family.access.backToTeam':         '← Equip',
  'family.access.privacy.updated':    'Privacitat actualitzada.',

  // Atenció directa — flux auxiliar (H-09 / UX-A01)
  'care.page.title':                  'Atenció directa',
  'care.offline.notice':              'Sense connexió: els teus registres es guarden al dispositiu i s\'envien sols en recuperar la xarxa.',
  'care.vitals.title':                'Constants',
  'care.vitals.submit':               'Registrar constants',
  'care.intake.title':                'Ingesta',
  'care.intake.meal':                 'Àpat',
  'care.intake.quantity':             'Quantitat',
  'care.intake.submit':               'Registrar ingesta',
  'care.stool.title':                 'Deposició',
  'care.stool.notes':                 'Notes',
  'care.stool.submit':                'Registrar deposició',
  'care.incident.title':              'Incidència',
  'care.incident.label':              'Descripció',
  'care.incident.submit':             'Registrar incidència',
  'care.records.title':               'Registres recents',
  'care.pending.title':               'Pendents de sincronitzar ({count})',
  'care.pending.syncNow':             'Sincronitzar ara',
  'care.pending.retrying':            'Reintentant',
  'care.pending.pending':             'Pendent',
  'care.yes':                         'Sí',
  'care.no':                          'No',

  // Facturació — strings residuals (H-03 / UX-A02)
  'billing.tariffs.vatYes':           'Sí',
  'billing.tariffs.vatNo':            'No',
  'billing.tariffs.edit':             'Editar',
  'billing.filter.yearAll':           'Any: Tots',
  'billing.filter.monthAll':          'Mes: Tots',
  'billing.invoices.resident':        'Resident',
  'billing.invoices.year':            'Any',
  'billing.invoices.month':           'Mes',
  'billing.invoices.series':          'Sèrie',
  'billing.invoices.payer':           'Pagador:',
  'billing.invoices.concept':         'Concepte',
  'billing.invoices.base':            'Base',
  'billing.invoices.vat':             'IVA',
  'billing.invoices.lineTotal':       'Total',
  'billing.invoices.exempt':          '(exempt)',
  'billing.invoices.grandTotal':      'TOTAL',
  'billing.invoices.creating':        'Creant…',
  'billing.invoices.draft.title':     'Factura',
  'billing.access.restricted':        'Accés restringit',
  'billing.access.noPermission':      'El teu rol no té permís per veure la secció de facturació.',

  // Residents/[id] — dades personals i pestanyes (H-04 / UX-A03)
  'exp.datos.title':                  'Dades personals',
  'exp.datos.tab':                    'Dades',
  'exp.escalas.tab':                  'Escales',
  'exp.contactos.tab':                'Contactes',
  'exp.alergias.tab':                 'Al·lèrgies',
  'exp.datos.birthDate':              'Naixement',
  'exp.datos.admissionDate':          'Ingrés',
  'exp.datos.nationalId':             'DNI/NIE',
  'exp.datos.center':                 'Centre',
  'exp.datos.bed':                    'Plaça',
  'exp.datos.bloodGroup':             'Grup sanguini',
  'exp.datos.language':               'Idioma preferent',
  'exp.datos.noBed':                  'Sense plaça',
  'exp.status.active':                'Actiu',
  'exp.status.discharged':            'Finalitzada',
  'exp.consent.ok':                   'Consentiment ok',
  'exp.consent.missing':              'Sense consentiment',
  'exp.falls.witnessed':              'Presenciada',
  'exp.falls.injuries':               'Lesions: {text}',
  'exp.dx.diag':                      'Diag.:',

  // Admissions — strings residuals (H-05 / UX-A04)
  'admissions.tab.pipeline':          'Llista d\'espera / Pipeline',
  'admissions.forecast.date':         'Data',
  'admissions.form.center.ph':        'Selecciona un centre…',
  'admissions.form.unit.none':        'Sense preferència d\'unitat',
  'admissions.actions.selectStatus':  'Selecciona el nou estat…',

  // Targeta MFA — strings residuals (H-07 / UX-A04)
  'mfa.description':                  "La verificació en dos passos afegeix una capa extra de seguretat al teu compte. Necessitaràs una aplicació d'autenticació (Google Authenticator, Authy, etc.) per obtenir un codi d'accés de 6 dígits cada vegada que iniciïs la sessió.",
  'mfa.activate':                     'Activar',
  'mfa.codesLow':                     "Tens pocs codis de recuperació disponibles. Considera regenerar-los.",

  // Accés restringit global (facturació/admissions)
  'access.restricted.title':          'Accés restringit',
  'access.restricted.desc':           'El teu rol no té permís per veure aquesta secció.',
};
